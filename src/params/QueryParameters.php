...
namespace shiyun\annotation\params;

use shiyun\annotation\exceptions\QueryParametersException;
...
class QueryParameters
{
    ...
    public function setDefaultValue($routerParam, mixed $param): mixed
    {
        ...
        if (is_numeric($param) && !in_array('string', $routerParam['type'])) {
            ...
            if (!$value && $param != $value) throw new QueryParametersException('QueryParam Name: ' . $routerParam['name'] . ' miss', 401);
            return $value;
        }
