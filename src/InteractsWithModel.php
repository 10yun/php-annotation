...
use ReflectionClass;
use shiyun\annotation\model\relation\BelongsTo;
use shiyun\annotation\model\relation\BelongsToMany;
use shiyun\annotation\model\relation\HasMany;
use shiyun\annotation\model\relation\HasManyThrough;
use shiyun\annotation\model\relation\HasOne;
use shiyun\annotation\model\relation\HasOneThrough;
use shiyun\annotation\model\relation\MorphByMany;
use shiyun\annotation\model\relation\MorphMany;
use shiyun\annotation\model\relation\MorphOne;
use shiyun\annotation\model\relation\MorphTo;
use shiyun\annotation\model\relation\MorphToMany;
use think\App;
