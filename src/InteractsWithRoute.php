...
use shiyun\annotation\route\Group;
use shiyun\annotation\route\Middleware;
use shiyun\annotation\route\Model;
use shiyun\annotation\route\Resource;
use shiyun\annotation\route\Validate;
use think\App;
use think\event\RouteLoaded;

/**
 * Trait InteractsWithRoute
 * @package shiyun\annotation\traits
 * @property App $app
